...
timeout 144000 julia --project=. src/Autumn/generativemodel/final_evaluation.jl wind
timeout 144000 julia --project=. src/Autumn/generativemodel/final_evaluation_sketch.jl wind
timeout 144000 julia --project=. src/Autumn/generativemodel/final_evaluation_sketch_SINGLE.jl wind
