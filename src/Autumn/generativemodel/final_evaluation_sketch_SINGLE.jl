...
# function parameter_specified_run(algorithm="sketch_single") 
#   solutions_dict = Dict()
...
function run_model(model_name::String, desired_per_matrix_solution_count, desired_solution_count)
  ...
  directory_name = string("sketch_SINGLE_final_results/results_$(date_string)")
  mkdir(directory_name)
  directory_name = string("sketch_SINGLE_final_results/results_$(date_string)/", model_name)
  mkdir(directory_name)
...
function run_all_models(desired_per_matrix_solution_count, desired_solution_count)
  ...
  for model_name in models
    x = @timed run_model(model_name, desired_per_matrix_solution_count, desired_solution_count)
    save("woah_SINGLE_$(model_name).jld", model_name, x)
  end
end
