...
do
  ...
  do
    ...
    do
      ...
      nohup timeout 86400 /scratch/riadas/julia-1.5.4/bin/julia --project=. evaluation/cisc/scripts/full_eval.jl $model_name $algorithm $curr_date $i > OCTOBER_TESTING_OUTS/$model_name.$algorithm.out & 
      sleep 60
    done
    sleep 28800  
  done
